...
Status | | ![example label](https://labl.es/svg?text=blocked&bgcolor=2ae0bc) ![example label](https://labl.es/svg?text=blocker&bgcolor=2ae0bc) ![example label](https://labl.es/svg?text=stalled&bgcolor=c6ffda) ![example label](https://labl.es/svg?text=question&bgcolor=c6ffda) ![example label](https://labl.es/svg?text=needs%20revision&bgcolor=c6ffda)  ![example label](https://labl.es/svg?text=needs%20estimate&bgcolor=c6ffda) ![example label](https://labl.es/svg?text=has%20workaround&bgcolor=c6ffda) ![example label](https://labl.es/svg?text=changes%20requested&bgcolor=c6ffda) ![example label](https://labl.es/svg?text=duplicate&bgcolor=c6ffda)
